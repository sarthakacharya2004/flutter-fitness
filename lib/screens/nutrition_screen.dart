        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                children: const [
                  NutritionCard(meal: 'Breakfast', details: 'Oatmeal with fruits'),
                  NutritionCard(meal: 'Lunch', details: 'Grilled chicken with vegetables'),
                  NutritionCard(meal: 'Dinner', details: 'Salmon with quinoa'),
                  NutritionCard(meal: 'Snack', details: 'Greek yogurt with nuts'),
                ],
              ),
            ),
            Center(
...
class NutritionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        title: Text(meal, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
